...
class Graph(List_):
    ...
    self,
    value: Any,
    other_values: Optional[Any] = None  # <--- Añadimos este parámetro
    )  -> None:
    # Pasamos 'other_values' al constructor del nodo
    ...
    def exist_path(self, origin, destination):
        ...
        self.mark_as_unvisited() # Reset visited before search
    ...
    def amplitude_sweep(self, value)-> None: # breadth-first search
        queue_vertex = Queue_()
